...
import com.clank.launcher.auth.AccountList;
import com.clank.launcher.auth.LoginService;
import com.clank.launcher.auth.YggdrasilLoginService;
import com.clank.launcher.dialog.LauncherFrame;
...
import com.clank.launcher.util.SharedLocale;
import com.clank.launcher.util.SimpleLogFormatter;
...
public final class Launcher {
    ...
    public Launcher(@NonNull File baseDir) throws IOException {
        SharedLocale.loadBundle("com.clank.launcher.lang.Launcher", Locale.getDefault());

        this.baseDir = baseDir;
        this.properties = LauncherUtils.loadProperties(Launcher.class,
                "launcher.properties", "com.clank.launcher.propertiesFile");
